...
// Type for trending repo entry (based on huchenme / github-trending-api)
  ...
  useEffect(() => {
    const fetchTrending = async () => {
      ...
      try {
        ...
        const picks = data
          .flatMap((repo) =>
            [`${repo.author}/${repo.name}`, repo.language].filter(Boolean)
          )
          .slice(0, 6);
        setPopularSearches(picks as string[]);
      } catch (err) {
            ...
            <div className="relative">
              ...
              >
                <Input
                  ...
                  type="text"
                  placeholder="Paste link or Search repositories... (e.g., 'react', 'user:facebook', 'language:typescript')"
                  value={query}
